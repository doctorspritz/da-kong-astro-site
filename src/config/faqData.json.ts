...
export const faqData: FaqItem[] = [
  {
    ...
    answer:
      `These themes are for developers who want to have pre-created templates to use in their projects,
  ...
  },
  {
    ...
    answer:
      `60+ components. Including 6 feature sections, 3 hero sections, 2 services sections, 2 testimonial sections, 
  ...
  },
  {
    ...
    answer:
      `When you purchase any of our themes, you get lifetime updates for free. 
  ...
  },
  {
    question: "Why Astro?",
    answer:
      `Astro is an excellent framework for content-focused websites, with a great developer
  ...
  },
  {
    ...
    answer:
      `Yes, you can use any of our themes for as many projects as you like.
  ...
  },
  {
    ...
    answer:
      `You can download any new versions of the themes by accessing
